...
export function provideDateFnsAdapter(formats?: MatDateFormats): Provider[] {
  return [
    {provide: DateAdapter, useClass: DateFnsAdapter, deps: [MAT_DATE_LOCALE, MAT_DATE_FORMATS]},
    {provide: MAT_DATE_FORMATS, useValue: formats || MAT_DATE_FNS_FORMATS},
  ];
}
...
export class DateFnsAdapter extends DateAdapter<Date, Locale> {
  constructor() {
    super();
    const matDateLocale = inject(MAT_DATE_LOCALE, { optional: true }) || ptBR; // Define o locale padrão como ptBR
